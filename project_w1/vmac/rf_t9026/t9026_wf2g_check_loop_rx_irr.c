...
int t9026_wf2g_check_loop_rx_irr(struct wf2g_rxirr_result* wf2g_rxirr_result, unsigned int bw_idx)
{
    ...
    rg_recv_a3.b.rg_rxirr_eup_0 = wf2g_rxirr_result->cal_rx_irr.coeff_eup[0];
    rg_recv_a3.b.rg_rxirr_eup_1 = wf2g_rxirr_result->cal_rx_irr.coeff_eup[1];
    fi_ahb_write(RG_RECV_A3, rg_recv_a3.data);

    rg_recv_a4.data = fi_ahb_read(RG_RECV_A4);
    rg_recv_a4.b.rg_rxirr_eup_2 = wf2g_rxirr_result->cal_rx_irr.coeff_eup[2];
    rg_recv_a4.b.rg_rxirr_eup_3 = wf2g_rxirr_result->cal_rx_irr.coeff_eup[3];
    fi_ahb_write(RG_RECV_A4, rg_recv_a4.data);

    rg_recv_a5.data = fi_ahb_read(RG_RECV_A5);
    rg_recv_a5.b.rg_rxirr_pup_0 = wf2g_rxirr_result->cal_rx_irr.coeff_pup[0];
    rg_recv_a5.b.rg_rxirr_pup_1 = wf2g_rxirr_result->cal_rx_irr.coeff_pup[1];
    fi_ahb_write(RG_RECV_A5, rg_recv_a5.data);

    rg_recv_a6.data = fi_ahb_read(RG_RECV_A6);
    rg_recv_a6.b.rg_rxirr_pup_2 = wf2g_rxirr_result->cal_rx_irr.coeff_pup[2];
    rg_recv_a6.b.rg_rxirr_pup_3 = wf2g_rxirr_result->cal_rx_irr.coeff_pup[3];
    fi_ahb_write(RG_RECV_A6, rg_recv_a6.data);

    rg_recv_a7.data = fi_ahb_read(RG_RECV_A7);
    rg_recv_a7.b.rg_rxirr_elow_0 = wf2g_rxirr_result->cal_rx_irr.coeff_elow[0];
    rg_recv_a7.b.rg_rxirr_elow_1 = wf2g_rxirr_result->cal_rx_irr.coeff_elow[1];
    fi_ahb_write(RG_RECV_A7, rg_recv_a7.data);

    rg_recv_a8.data = fi_ahb_read(RG_RECV_A8);
    rg_recv_a8.b.rg_rxirr_elow_2 = wf2g_rxirr_result->cal_rx_irr.coeff_elow[2];
    rg_recv_a8.b.rg_rxirr_elow_3 = wf2g_rxirr_result->cal_rx_irr.coeff_elow[3];
    fi_ahb_write(RG_RECV_A8, rg_recv_a8.data);

    rg_recv_a9.data = fi_ahb_read(RG_RECV_A9);
    rg_recv_a9.b.rg_rxirr_plow_0 = wf2g_rxirr_result->cal_rx_irr.coeff_plow[0];
    rg_recv_a9.b.rg_rxirr_plow_1 = wf2g_rxirr_result->cal_rx_irr.coeff_plow[1];
    fi_ahb_write(RG_RECV_A9, rg_recv_a9.data);

    rg_recv_a10.data = fi_ahb_read(RG_RECV_A10);
    rg_recv_a10.b.rg_rxirr_plow_2 = wf2g_rxirr_result->cal_rx_irr.coeff_plow[2];
    rg_recv_a10.b.rg_rxirr_plow_3 = wf2g_rxirr_result->cal_rx_irr.coeff_plow[3];
    ...
    if(pass_idx == 2 * cnt_max)
        RF_DPRINTF(RF_DEBUG_RESULT_CHECK, "WF2G All freq IRR test is pass!\n");
    ...
    fi_ahb_write(RG_XMIT_A3, rg_xmit_a3.data);
    RF_DPRINTF(RF_DEBUG_RESULT_CHECK, "WF2G Check loop Rx IRR finish \n");
