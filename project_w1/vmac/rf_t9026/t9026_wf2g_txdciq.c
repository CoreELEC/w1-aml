...
void t9026_wf2g_txiqdc(struct wf2g_txdciq_result* wf2g_txdciq_result, U8 tx_pa_gain, U8 tx_mxr_gain, bool check_flg)
{
    ...
    // Internal variables definitions
    bool    RG_TX_A4_saved = False;
    RG_TX_A4_FIELD_T    rg_tx_a4_i;
    // Internal variables definitions
    ...
    if(!RG_TX_A6_saved) {
        RG_TX_A6_saved = True;
        rg_tx_a6_i.b.RG_WF2G_TX_IQCAL_EN = rg_tx_a6.b.RG_WF2G_TX_IQCAL_EN;
        rg_tx_a6_i.b.RG_WF2G_TX_PA_GAIN_MAN = rg_tx_a6.b.RG_WF2G_TX_PA_GAIN_MAN;
        rg_tx_a6_i.b.RG_WF2G_TX_MXR_GAIN_MAN = rg_tx_a6.b.RG_WF2G_TX_MXR_GAIN_MAN;
        rg_tx_a6_i.b.RG_WF2G_TX_MAN_MODE = rg_tx_a6.b.RG_WF2G_TX_MAN_MODE;
    }
    rg_tx_a6.b.RG_WF2G_TX_IQCAL_EN = 0x1;
    ...
    if(tx_mxr_gain == 7) {
        ...
        rg_rx_a2.b.RG_WF_RX_GAIN_MAN = 0x86;  //83
        ...
        if (!RG_TX_A4_saved) {
            RG_TX_A4_saved = True;
            rg_tx_a4_i.b.RG_WF2G_TX_MXR_CBANK = rg_tx_a4.b.RG_WF2G_TX_MXR_CBANK;
        }
        rg_tx_a4.b.RG_WF2G_TX_MXR_CBANK = 0x4;
        rf_write_register(RG_TX_A4, rg_tx_a4.data);

    } else if(tx_mxr_gain == 3) {
        rg_rx_a2.data = rf_read_register(RG_RX_A2);
        if(!RG_RX_A2_saved) {
            RG_RX_A2_saved = True;
            rg_rx_a2_i.b.RG_WF_RX_GAIN_MAN = rg_rx_a2.b.RG_WF_RX_GAIN_MAN;
        ...
        rg_rx_a2.b.RG_WF_RX_GAIN_MAN = 0x86;
        rg_rx_a2.b.RG_WF_RX_GAIN_MAN_MODE = 0x1;
        rf_write_register(RG_RX_A2, rg_rx_a2.data);
        ...
        rg_rx_a2.b.RG_WF_RX_GAIN_MAN = 0x89;
        rg_rx_a2.b.RG_WF_RX_GAIN_MAN_MODE = 0x1;
        rf_write_register(RG_RX_A2, rg_rx_a2.data);
    }
    ...
    rg_xmit_a46.b.rg_txpwc_comp_man = 0x10;
    ...
    rg_esti_a23.b.rg_txirr_oper_bnd = 0x2;
...
//set TX DC/IRR comp manual mode to 1
    ...
    if(check_flg == 1)
    {
         t9026_wf2g_txiqdc_check(tx_mxr_gain);
    }
    ...
    // Revert the original value before calibration back
    rg_tx_a6.data = rf_read_register(RG_TX_A6);
    rg_tx_a6.b.RG_WF2G_TX_IQCAL_EN = rg_tx_a6_i.b.RG_WF2G_TX_IQCAL_EN;
    rg_tx_a6.b.RG_WF2G_TX_PA_GAIN_MAN = rg_tx_a6_i.b.RG_WF2G_TX_PA_GAIN_MAN;
    rg_tx_a6.b.RG_WF2G_TX_MXR_GAIN_MAN = rg_tx_a6_i.b.RG_WF2G_TX_MXR_GAIN_MAN;
    ...
    fi_ahb_write(RG_ESTI_A14, rg_esti_a14.data);
    wf2g_txdciq_result->cal_tx_dciq.tx_dc_i = dci;
    wf2g_txdciq_result->cal_tx_dciq.tx_dc_q = dcq;
    wf2g_txdciq_result->cal_tx_dciq.tx_alpha = alpha;
    wf2g_txdciq_result->cal_tx_dciq.tx_theta = theta;
    RF_DPRINTF(RF_DEBUG_INFO, "----------------------> TX DC&IRR out\n");
    RF_DPRINTF(RF_DEBUG_RESULT, "2g unlock_cnt %d, dci: 0x%x dcq: 0x%x alpha:0x%x  theta:0x%x\n", unlock_cnt, dci, dcq, alpha, theta);
