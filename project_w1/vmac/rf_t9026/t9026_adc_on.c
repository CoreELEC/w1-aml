...
void t9026_adc_on(void)
{
    ...
    rg_top_a17.b.rg_m0_wf_wadc_enable_i = 0x1;
    rg_top_a17.b.rg_m0_wf_wadc_enable_q = 0x1;
    rf_write_register(RG_TOP_A17, rg_top_a17.data);

    rg_top_a18.data = rf_read_register(RG_TOP_A18);
    rg_top_a18.b.rg_m1_wf_wadc_enable_i = 0x1;
    rg_top_a18.b.rg_m1_wf_wadc_enable_q = 0x1;
    ...
    rg_top_a20.b.rg_m3_wf_wadc_enable_i = 0x1;
    rg_top_a20.b.rg_m3_wf_wadc_enable_q = 0x1;
    rf_write_register(RG_TOP_A20, rg_top_a20.data);

    rg_top_a21.data = rf_read_register(RG_TOP_A21);
    rg_top_a21.b.rg_m4_wf_wadc_enable_i = 0x1;
    rg_top_a21.b.rg_m4_wf_wadc_enable_q = 0x1;
    rf_write_register(RG_TOP_A21, rg_top_a21.data);

    rg_top_a22.data = rf_read_register(RG_TOP_A22);
    rg_top_a22.b.rg_m5_wf_wadc_enable_i = 0x1;
    rg_top_a22.b.rg_m5_wf_wadc_enable_q = 0x1;
    ...
    rg_top_a24.b.rg_m7_wf_wadc_enable_i = 0x1;
    rg_top_a24.b.rg_m7_wf_wadc_enable_q = 0x1;
